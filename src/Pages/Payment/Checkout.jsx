            ...
            <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                ...
                <div className="px-4 space-y-5 text-center">
                        <p className="text-[17px]">
                            ...
                            All the existing and new launched course be also available
                        </p>
                        ...
                        <button type="submit" className="bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 absolute left-0 bottom-0 w-full text-xl font-bold rounded-bl-lg rounded-br-lg py-2" >
                            Buy Now
                        </button>
                    </div>
            </div>
