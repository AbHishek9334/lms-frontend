            ...
            <div className="flex items-center justify-center h-[100vh]">
                <form noValidate onSubmit={createnewAccount} className="flex-flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input type="text" required name="fullName" id="fullName" placeholder="Enter your name..." className="bg-transparent px-2 py-1 border" onChange={handleUserInput} value={signupData.fullName}/>
                    </div>
                    <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input type="password" required name="password" id="password" placeholder="Enter your email..." className="bg-transparent px-2 py-1 border" onChange={handleUserInput} value={signupData.password}/>
                    </div>
                    <button type="submit" className="mt-3 w-full bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm py-2 fontsemibold text-lg cursor-pointer">Create Account</button>
